...
export default function ApprovalLettersPage() {
  ...
  const handleCreateLetter = () => {
    ...
    window.location.href = '/cost/approvallettersdirectives/form';
  };

  return (
    <div>
      <div className="flex justify-between">
        <h1>Approval Letters &amp; Directives</h1>
        ...
        {letters.map(letter => (
          <Card key={letter.id}>
            <CardHeader>
              ...
              <CardDescription>Approval Letter or Directive</CardDescription>
            </CardHeader>
            <CardContent>
